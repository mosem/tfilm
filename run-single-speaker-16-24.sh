...
python src/run.py train \
  --train ./data/vctk/speaker1/16-24/0.5-0.5/vctk-speaker1-train.1.5.24000.8192.4096.h5 \
  --val ./data/vctk/speaker1/16-24/0.5-0.5/vctk-speaker1-val.1.5.24000.8192.4096.h5\
  -e 50 \
  --batch-size 64 \
  --lr 3e-4 \
